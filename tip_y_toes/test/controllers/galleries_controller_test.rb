...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { image: @gallery.image, name: @gallery.name } }, as: :json
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { image: @gallery.image, name: @gallery.name } }, as: :json
    assert_response 200
  end
